...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $update = $pdo->prepare("UPDATE students SET name = ? WHERE id = ?");
        ...
        <div class="card">
            <div class="form-container">
                ...
                <div class="student-info">
                    ...
                    <p><strong>Current Name:</strong> <?php echo htmlspecialchars($student['name']); ?></p>
                    <?php if ($student['created_at']): ?>
                    <p><strong>Created:</strong> <?php echo date('F j, Y, g:i a', strtotime($student['created_at'])); ?></p>
                    <?php endif; ?>
                </div>
                ...
                <form method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="name" class="form-control" 
                               ...
                               placeholder="Enter new student name" required>
                    </div>
